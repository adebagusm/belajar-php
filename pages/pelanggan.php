            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <!-- Product Loop -->
                        <li class="nav-item">
                            <a href="jumlah-product.php" class="nav-link active">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-3">
                            ...
                            <div class="">
                                ...
                                <a href="tambah-pelanggan.php" class="btn btn-block btn-primary">Tambah Data <i
                        ...
                        LIMIT $per_page OFFSET $start_from";
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo '<td>
                                        <a href="edit-pelanggan.php?id=' . $row["id"] . '" class="btn btn-warning">Edit</a>
